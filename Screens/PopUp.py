...
# PopUp
#
# Pop-up Button Objects for displaying various screen pop-ups
#
###############################################################################
import curses
import curses.panel
...
class PopUpOk(PopUp):
    def __init__(self, text):
        ...
        okButton = BaseButton("OK", self.ClosePopUp, 1, 4, 13, 36, {"disable_screen_switch":True, "disable_tab":True})
